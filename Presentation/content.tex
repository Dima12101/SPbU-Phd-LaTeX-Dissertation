...
\begin{frame}
	\frametitle{Домен исследования: AMR-система}
	\small
...
\begin{frame}
	\frametitle{Управление ресурсами}
	\begin{enumerate}
		...
		\item распределение вычислительных ресурсов (\textit{resource allocation}) --- назначение задачам вычислительной мощности, памяти и сетевой ёмкости;
	...
	\end{block}
\end{frame}
\note{Имеется внешний эффект --- влияние на остальные задачи, очереди и доступность периферийных ресурсов. Требуется формальное правило координации, которое связывает локальные сообщения участников с общим критерием качества системы.}

\begin{frame}
	\frametitle{Миопичность распределения}
...
\begin{frame}
	...
	\begin{align*}
		P^{viol}_{\tau j}(t) &= \rho^{viol}_{c_{\tau}}
		\left[\frac{T_{\tau j}(t)-\Delta_{\tau}}{\Delta_{\tau}+\varepsilon}\right]_+
	\end{align*}
\end{frame}
...
\begin{frame}
	\frametitle{Проектирование экономических механизмов}
	\small
...
\begin{frame}
	...
	\begin{align*}
		o^j_t & \rightarrow \kappa_j(t) \rightarrow
...
\begin{frame}
	\frametitle{MARL-контур: командное вознаграждение}
	\small
...
\begin{frame}
	\frametitle{Метрики экспериментов}
	\scriptsize
...
\begin{frame}[plain,noframenumbering]
    \begin{center}
        \Huge Полученные результаты
    \end{center}
\end{frame}

\begin{frame}
	\frametitle{Обучение политики режимов}
	\small
	\begin{center}
...
\begin{frame}
	\frametitle{Поведение обученной политики}
	\small
	\begin{center}
...
\begin{frame}
    \frametitle{Интегральное качество: общественное благосостояние}
    \small
    \begin{center}
...
\begin{frame}
    \frametitle{Масштабируемость: когда нужна кластеризация}
    \small
     \begin{center}
