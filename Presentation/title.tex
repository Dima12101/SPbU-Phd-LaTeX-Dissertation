...
%\title{\small{Название презентации}} TODO
\title{Модели и методы адаптивного управления ИТ‑ресурсами в распределенных многоагентных системах на уровне периферийных вычислений}
\author{%
    \texorpdfstring{%
