...
%%% Стили %%%
%\bibliographystyle{BibTeX-Styles/utf8gost71u_temp}    % Оформляем библиографию по ГОСТ 7.1 (ГОСТ Р 7.0.11-2011, 5.6.7)
...
% При переключении с biblatex/biber на bibtex8 в .aux могут остаться служебные
% команды \abx@aux@... . Делаем их no-op, чтобы первый прогон pdflatex не падал
% и успевал переписать aux в формате bibtex.
\makeatletter
